...
const mockSalesData: MonthlyComparison = {
  currentMonth: [
    {
      salespersonId: '1',
      salespersonName: 'Vendedor 1',
      email: 'vendedor1@suaempresa.mz',
      phone: '+258 84 000 0001',
      totalSales: 25000,
      clientsRegistered: 5,
      contractsIssued: 4,
      contractsSigned: 3,
      averageContractValue: 8333,
      conversionRate: 75,
      lastSale: '2024-03-30',
      monthlyTarget: 30000,
      achievement: 83.33
    ...
    {
      salespersonId: '2',
      salespersonName: 'Vendedor 2',
      email: 'vendedor2@suaempresa.mz',
      phone: '+258 85 000 0002',
      totalSales: 18000,
      clientsRegistered: 4,
      contractsIssued: 3,
      contractsSigned: 2,
      averageContractValue: 9000,
      conversionRate: 66.7,
      lastSale: '2024-03-29',
      monthlyTarget: 25000,
      achievement: 72.0
