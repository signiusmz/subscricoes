...
const mockServices: Service[] = [
  {
    ...
    description: 'Serviço completo de contabilidade mensal incluindo balancetes e demonstrações financeiras',
    price: 5000,
    ivaType: 'additional',
    ivaAmount: 800,
    totalPrice: 5800,
  ...
  },
  {
    ...
    description: 'Auditoria externa completa das contas anuais da empresa',
    price: 15000,
    ivaType: 'additional',
    ivaAmount: 2400,
    totalPrice: 17400,
